...
export default function ConnectedDevices({ sessions }: Props) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Review every device currently signed in to your account.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        {sessions.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="font-semibold">No active devices</h3>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            <h3 className="font-semibold">
                              {session.current ? "This Device" : "Connected Device"}
                            </h3>
                          ...
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <span>{browser} {browserVersion}</span>
                          </div>
